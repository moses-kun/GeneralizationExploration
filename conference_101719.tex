...
To work in a large scale implementation, placement algorithm also needed to work on a low complexity. Previous methods 

Previous approach using heuristic, meta-heuristic, framework, and matematical model relies 

Approaching placement problem as generative classication problem similar to machine translation can be the solution to these problem. Similar to machine translation problem: bla bla 

However, in the same way there is a need to improve specifity of the model, and improve its training time to be able to implement deep learning into this problem. We argue that encoder and decoder algorithm can provide the generative solution
